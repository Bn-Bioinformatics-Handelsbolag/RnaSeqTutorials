...
#' \item\code{07_non_model_organism_exploratory_data_analysis} the exploratory data analysis of a Norway spruce RNA-Seq dataset (a non-model organism)
#' \item\code{08_non_model_organism_differential_gene_expression} the differential expression DE analysis of the Norway spruce RNA-Seq dataset
#' }
#'
